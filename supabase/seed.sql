...
values
  ...
  ('automotive-mechanics', 'Automotive Mechanics', 'technical_skill', 'Maintains and repairs road vehicles, including light-duty vehicles, minibuses, and trucks.'),
...
-- Interest suggestions, expanded pathways, and demo role mirror of migration 20260925033014.
insert into public.occupations (slug, title, isco08_code, isco08_level, role_family, value_chain_stages, source_summary, source_url, source_locator, industry_transfer_summary)
values
...
with role_data(id, company_id, occupation_slug, title, description, location, employment_type) as (values
  ...
  ('40000000-0000-0000-0000-000000000030'::uuid, '10000000-0000-0000-0000-000000000001'::uuid, 'ship-and-aircraft-controllers-and-technicians', 'Marine Systems Support Assistant', 'Demo career profile for exploring marine support work. This is not an employer vacancy.', 'Guyana / Marine operations', 'Demo career profile'),
