...
type CareerInterest = { display_order: number; group_name: "Hands-on" | "Field and care" | "Technical and digital" | "Business and service"; is_active: boolean; label: string; slug: string };
type OccupationCareerInterest = { career_interest_slug: string; is_active: boolean; occupation_id: string; relevance_weight: number };
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      career_interests: Table<CareerInterest, Pick<CareerInterest, "slug" | "label" | "group_name" | "display_order"> & Partial<CareerInterest>, Partial<CareerInterest>>;
      occupation_career_interests: Table<OccupationCareerInterest, Pick<OccupationCareerInterest, "occupation_id" | "career_interest_slug" | "relevance_weight"> & Partial<OccupationCareerInterest>, Partial<OccupationCareerInterest>>;
    ...
    Functions: {
      ...
      get_public_occupations: { Args: Record<string, never>; Returns: Array<{ id: string; slug: string; title: string; isco08_code: string; isco08_level: "unit" | "minor" | "sub_major" | "major"; role_family: string; value_chain_stages: string[]; source_summary: string; source_url: string; source_locator: string | null; local_content_categories: string[]; example_titles: string[]; industry_transfer_summary: string; career_interests: Json }> };
      get_public_career_interests: { Args: Record<string, never>; Returns: Array<{ slug: string; label: string; group_name: "Hands-on" | "Field and care" | "Technical and digital" | "Business and service"; display_order: number }> };
